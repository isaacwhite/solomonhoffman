...
$(window).load(function() {
  $('.field-series-photos').flexslider();
});
</script>
<link rel="stylesheet" href="/sites/all/themes/custom/hoffman/js/vendor/flexslider/flexslider.css">
  ...
  <?php endif; ?>
    <ul class="slides field-items"<?php print $content_attributes; ?>>
      <?php foreach ($items as $delta => $item): ?>
        <li class="field-item <?php print $delta % 2 ? 'odd' : 'even'; ?>"<?php print $item_attributes[$delta]; ?>><?php 
        print render($item); 
        ?></li>
      <?php endforeach; ?>
    </ul>
